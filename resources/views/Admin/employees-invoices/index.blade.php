...
@endphp
@section('title',__('website.projects-files'))
@section('header')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bolder my-0 fs-2">{{trans('website.'.$route)}} </h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">{{__('lang.project_name')}}</th>
                            <th class="min-w-100px">{{__('lang.price')}}</th>
                            <th class="min-w-100px">{{__('lang.type')}}</th>
                            <th class="min-w-100px">{{__('lang.file')}}</th>
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'project_name', name: 'project_name', "searchable": false, "orderable": false},
