...
@php
    $route = 'product_sizes';
@endphp
@section('title',__('lang.product_sizes'))
@section('header')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bolder my-0 fs-2">{{trans('lang.product_sizes')}} </h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.size')}}</th>
