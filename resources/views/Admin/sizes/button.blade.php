...
<div class="dt-buttons flex-wrap">
    ...
    <!--begin::Add user-->
    <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
            data-bs-target="#kt_modal_add_excel">
        <i class="bi bi-plus-circle-fill fs-2x"></i>
    </button>
    <!--end::Add user-->
    ...
    <div class="modal fade" id="kt_modal_add_excel" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" method="post" action="{{url($route.'/excel')}}"
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-12">
                                    <input type="file" @if(request()->segment(2) != 'edit') required @endif name="sizes" multiple
                                           data-default-file="">
                                </div>
                            </div>
                            <!--end::Actions-->
