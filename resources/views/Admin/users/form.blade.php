...
<div class="fv-row mb-7">
    <!--begin::Label-->
    <label class="required fw-bold fs-6 mb-2">المسمى الوظيفى</label>
    <!--end::Label-->
    <!--begin::Input-->
    <select name="role" class="form-control">

        <option @isset($data) @if($data->role == 'admin') selected @endif @endisset value="admin">مدير</option>
        <option @isset($data) @if($data->role == 'employee') selected @endif @endisset value="admin">موظف</option>
        <option @isset($data) @if($data->role == 'sales') selected @endif @endisset value="admin">مبيعات</option>
