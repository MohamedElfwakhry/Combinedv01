                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{$counts['users']}}</div>
                            <div class="fw-bold text-gray-100">{{__('lang.products')}}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$counts['users']}}</div>
                            <div class="fw-bold text-gray-100">{{__('lang.Categories')}}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$counts['users']}}</div>
                            <div class="fw-bold text-white">{{__('lang.contact_us')}}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{$counts['users']}}</div>
                            <div class="fw-bold text-gray-400">Pending Orders</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{$counts['users']}}</div>
                            <div class="fw-bold text-gray-100">{{__('lang.accepted_orders')}}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$counts['users']}}</div>
                            <div class="fw-bold text-white">{{__('lang.completed_orders')}}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$counts['users']}}</div>
                            <div class="fw-bold text-white">{{__('lang.canceled_orders')}}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                series: [
                    {
                        ...
                        data: [
                            @for($x=1; $x<=12; $x++)
                                "{{\App\Models\Order::where('type','pending')->whereYear('created_at',date('Y'))->whereMonth('created_at',$x)->count()}}",
                            @endfor
                        ],
                    ...
                    },
                    {
                        ...
                        data: [
                            @for($x=1; $x<=12; $x++)
                                "{{\App\Models\Order::where('type','completed')->whereYear('created_at',date('Y'))->whereMonth('created_at',$x)->count()}}",
                            @endfor
                        ],
                    }
                ],
