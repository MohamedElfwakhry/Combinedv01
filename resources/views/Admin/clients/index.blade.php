...
@section('header')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bolder my-0 fs-2">{{trans('lang.Clients')}} </h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-75px">{{__('lang.name')}}</th>
                            <th class="min-w-75px">{{__('lang.phone')}}</th>
                            <th class="min-w-75px">{{__('lang.address')}}</th>
                            <th class="min-w-75px">{{__('lang.type')}}</th>
                            <th class="min-w-75px">{{__('lang.Actions')}}</th>
                        </tr>
                        <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
