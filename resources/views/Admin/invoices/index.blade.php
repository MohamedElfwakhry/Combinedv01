...
@section('header')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bolder my-0 fs-2">{{trans('invoice.invoices')}} </h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-50px">{{__('lang.client')}}</th>
                            <th class="min-w-50px">{{__('lang.date')}}</th>
                            <th class="min-w-50px">{{__('lang.total_price')}}</th>
                            <th class="min-w-50px">{{__('lang.discount')}}</th>
                            <th class="min-w-50px">{{__('lang.project')}}</th>
