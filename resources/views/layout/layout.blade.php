...
-->
<html lang="en" @if(LaravelLocalization::getCurrentLocale() ==  'ar')dir="rtl" @endif>
<!--begin::Head-->
<head>
    <base href="../">
    <title> Combined System || @yield('title')
    </title>
    <meta charset="utf-8"/>
        ...
        <div id="kt_aside" class="aside aside-extended" data-kt-drawer="true" data-kt-drawer-name="aside"
            ...
            <div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
                ...
                <div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10"
                     id="kt_aside_logo">
                    <a href="{{url('/')}}">
                        <img alt="Logo" src="{{asset('website/assets/images/logo/logo 1-100.jpg')}}" class="h-35px"/>
                    </a>
                </div>
                <!--end::Logo-->
                <!--begin::Nav-->
                ...
                <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                    ...
                    <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                        ...
                        <a href="{{url('/')}}" class="d-flex align-items-center">
                            <img alt="Logo" src="{{asset('website/assets/images/logo/logo 1-100.jpg')}}" class="h-30px"/>
                        </a>
                        <!--end::Logo-->
                    </div>
                    <!--end::Wrapper-->
