...
var KTGeneralApexCharts = {
    init: function () {
        ...
        new ApexCharts(e, {
            series: [
                { name: "Net Profit", data: [44, 55, 57, 56, 61, 58, 43, 56, 65, 41, 55, 66] },
                { name: "Cost", data: [32, 34, 52, 46, 27, 60, 41, 49, 13, 11, 44, 33] },
                { name: "Revenue", data: [76, 85, 101, 98, 87, 105, 87, 99, 75, 82, 91, 89] },
            ],
            chart: { fontFamily: "inherit", type: "bar", height: t, toolbar: { show: !1 } },
            plotOptions: { bar: { horizontal: !1, columnWidth: ["40%"], endingShape: "rounded" } },
            legend: { show: !1 },
            dataLabels: { enabled: !1 },
            stroke: { show: !0, width: 2, colors: ["transparent"] },
            xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: a, fontSize: "12px" } } },
            ...
            (function () {
                ...
                new ApexCharts(e, {
                    ...
                    chart: { fontFamily: "inherit", type: "bar", height: t, toolbar: { show: !1 } },
                    plotOptions: { bar: { horizontal: !0, columnWidth: ["30%"], endingShape: "rounded" } },
                    legend: { show: !1 },
                    dataLabels: { enabled: !1 },
                    stroke: { show: !0, width: 2, colors: ["transparent"] },
            ...
            (function () {
                ...
                new ApexCharts(e, {
                    ...
                    xaxis: {
                        ...
                        crosshairs: { position: "front", stroke: { color: i, width: 1, dashArray: 3 } },
            ...
            (function () {
                ...
                new ApexCharts(e, {
                    ...
                    colors: [i, r],
                    grid: { borderColor: s, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                    markers: { colors: [o, l], strokeColor: [o, l], strokeWidth: 3 },
                }).render();
            })(),
            (function () {
                ...
                new ApexCharts(e, {
                    ...
                    chart: { fontFamily: "inherit", stacked: !0, height: t, toolbar: { show: !1 } },
                    ...
                    colors: [i, r, o],
                    grid: { borderColor: s, strokeDashArray: 4, yaxis: { lines: { show: !0 } }, padding: { top: 0, right: 0, bottom: 0, left: 0 } },
                }).render();
            })(),
            (function () {
                ...
                if (e) {
                    var o = {
                        ...
                        chart: { type: "rangeBar", fontFamily: "inherit", height: t, toolbar: { show: !1 } },
                        colors: [a, i, s],
